...
- 팀전LIVE는 월례 청/홍 팀전과 자유대진의 참가자 확정, 팀배정, 대진표, 현장 운영, 승패 입력에 집중합니다.
- 시스템 관리자는 세팅과 예외 복구를 맡고, LIVE 현장 운영은 클럽 임원과 해당 LIVE의 임시 운영 도우미가 맡습니다.
- 일반 회원은 대진과 진행 상황 확인이 기본이며, 스마트폰 없이도 임원 안내만으로 참여할 수 있어야 합니다.
