...
| 2026-09-15 | 4코트 자동 투입 → 최신 경기 4→2 버튼 맞교환 → 4→3 축소 → 2코트 즉시 닫기·원대진 1순위 → 관리자 버튼 맞교환·재게시 | 통과. 세션 `D85VWVMJ`, 운영 코트 `[1,3,4]`, 관리자·임원·서버 revision 6 및 경기 일치. 숫자 입력 0개, 두 경로 `null` 정리 확인 |
