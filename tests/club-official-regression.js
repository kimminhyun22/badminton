...
let _dailyPaused=false;
let _dailyPausedAt=0;
let _dailyCheckinRequests=[{key:'yield1',type:'official-queue-yield',actorPlayerId:'official',queueId:'q1',token:'undo-yield',expectedQueueIndex:1,targetQueueIndex:4,expectedPlayerIds:['a','b','c','d'],expectedTeam1Ids:['a','b'],expectedTeam2Ids:['c','d']}];
let _dailyQueue=[
