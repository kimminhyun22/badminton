...
assert(checkin.includes('다음 대진 순서 조정')&&checkin.includes("type:'official-queue-yield'"),'클럽 임원은 특정 다음 대진을 선택한 순번까지 보낼 수 있어야 합니다.');
...
const multiMove=validationSandbox.api.apply('e','queue1','club-official-queue-yield',{strict:true,yieldedBy:'official',targetQueueIndex:4,clearRestPass:true});
