...
assert(checkin.includes("connected?'즉시 자동 처리':'연결 복구 중'"),'임원에게 별도 관리자 승인 없이 자동 처리되는 상태를 명확히 보여야 합니다.');
...
assert(officialPush.includes('연결 후 자동 적용'),'운영 화면이 잠시 끊겨도 저장된 요청이 재연결 후 자동 적용됨을 알려야 합니다.');
